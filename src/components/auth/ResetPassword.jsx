...
export default function ResetPassword() {
  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#060B18', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20, position: 'relative', overflow: 'hidden', fontFamily: font }}>
