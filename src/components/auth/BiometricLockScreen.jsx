...
export default function BiometricLockScreen({ org, userName, onUnlocked, onSignOut }) {
  ...
  return (
    <div style={{
      ...
      {org?.logo_url ? (
        <img src={org.logo_url} alt="" style={{ width: 62, height: 62, borderRadius: 16, objectFit: 'contain', background: 'var(--surface)', padding: 6, boxSizing: 'border-box', marginBottom: 22 }} />
      ) : (
