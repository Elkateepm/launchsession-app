            ...
            <div style={{ display: 'flex', gap: isMobile ? 6 : 8, alignItems: 'center', width: isMobile ? '100%' : undefined, overflowX: isMobile ? 'auto' : undefined, WebkitOverflowScrolling: 'touch', flexShrink: isMobile ? undefined : 0 }}>
              {[
                ...
                <button key={a.key} onClick={a.onClick} aria-label={a.label}
                  style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 4, flex: '0 0 auto', padding: '6px 4px', borderRadius: 14, border: '1.5px solid #E2E8F0', background: '#fff', color: '#374151', fontSize: isMobile ? 9.5 : 11, fontWeight: 800, cursor: 'pointer', boxShadow: '0 1px 4px -1px rgba(0,0,0,0.06)', textAlign: 'center', lineHeight: 1.15 }}>
