...
const styles = {
  ...
  tabs: { display: 'flex', gap: '8px', marginBottom: '24px', borderBottom: '1px solid var(--border, var(--border))', paddingBottom: '0' },
  ...
  row: { display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 0', borderBottom: '1px solid var(--border, var(--border-soft))' },
  colorDot: { width: '16px', height: '16px', borderRadius: '50%', flexShrink: 0 },
  locationIcon: { fontSize: '16px', flexShrink: 0 },
  labelInput: { flex: 1, border: '1px solid var(--border, var(--border))', borderRadius: '6px', padding: '6px 10px', fontSize: '14px', background: 'var(--input-bg, #fff)', color: 'var(--text-primary, #111)' },
  ...
  removeBtn: { background: 'none', border: 'none', color: 'var(--text-faint)', cursor: 'pointer', fontSize: '16px', padding: '0 4px', flexShrink: 0 },
  ...
  addInput: { flex: 1, minWidth: '160px', border: '1px solid var(--border, var(--border))', borderRadius: '6px', padding: '8px 12px', fontSize: '14px', background: 'var(--input-bg, #fff)', color: 'var(--text-primary, #111)' },
