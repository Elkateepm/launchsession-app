...
export default function BrandPreview({ draft, surface, device, terms = {} }) {
  ...
  const panel = { padding: 16, borderRadius: radius, background: 'var(--surface)', border: '1px solid #E5E9E6' }
  return <div data-testid="brand-preview" style={{ width: mobile ? 290 : '100%', maxWidth: '100%', margin: '0 auto', fontFamily: font.body, border: mobile ? '7px solid #222B29' : '1px solid #D9DEDB', borderRadius: mobile ? 32 : 15, overflow: 'hidden', boxShadow: '0 22px 50px rgba(21,42,32,.12)', background: 'var(--surface)', color: '#1E2D27' }}>
    ...
    {surface === 'email' && <div style={{ minHeight: mobile ? 450 : 398, padding: mobile ? 16 : 28, background: '#F0F2F1' }}>
      ...
      <div style={{ background: 'var(--surface)', borderRadius: 12, overflow: 'hidden', border: '1px solid #E0E5E1' }}>
