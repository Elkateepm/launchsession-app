...
function Err({ children }) {
  ...
  return <div style={{ padding: '10px 12px', borderRadius: 10, background: 'var(--danger-bg)',
    border: '1px solid var(--danger-border)', color: 'var(--danger-text)', fontSize: 13, marginBottom: 10 }}>{children}</div>
}
      ...
      {rows.map(r => (
        <div key={r.id} style={card}>
          ...
          {r.safeguarding_discussed && (
            <div style={{ fontSize: 12.5, color: 'var(--warn-text)', marginTop: 8, fontWeight: 700 }}>
